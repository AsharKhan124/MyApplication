...
/** Face Detector Demo. */
 public class FaceDetectionProcessor extends VisionProcessorBase<List<FirebaseVisionFace>> {
  ...
  public int canvasWidth(){
      return faceGraphic.canvasWidth();
  }

  public int canvasHeight(){
      return faceGraphic.canvasHeight();
  }


  public int getLeft(){
    return  Math.round(faceGraphic.getLeft());
  }
  public int getRight(){ return Math.round(faceGraphic.getRight()); }
  public int getTop(){
    return  Math.round(faceGraphic.getTop());
  }
  public int getBottom(){
    return  Math.round(faceGraphic.getBottom());
  }
