...
public class PigmentationProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pigmentation_product);
        mAuth = FirebaseAuth.getInstance();


        mToolbar = findViewById(R.id.all_product_list_app_bar);
        setSupportActionBar(mToolbar);
        getSupportActionBar().setTitle("Pigmentation Product");
        ...
        mDatabaseReference = FirebaseDatabase.getInstance().getReference().child("Products").child("Pigmentation");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(item.getItemId() == R.id.bucket){
            ...
            Intent intent = new Intent(PigmentationProductActivity.this,BucketActivity.class);
                                         ...
                                         public void onClick(View v) {
                                             ...
                                             bucketReference.child("Product_Code").setValue(itemcode).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                 ...
                                                 public void onComplete(@NonNull Task<Void> task) {
                                                     Toast.makeText(PigmentationProductActivity.this,"Product has been added to cart", Toast.LENGTH_SHORT).show();
